            ...
            if (user) {
                ...
                newUser.save(function(err) {
                    ...
                    else 
                    {
                        ...
                        {
                            to : email,
                            subject : "ifeelgood account activation",
                            text : "Welcome on ifeelgood. Please click the link bellow to activate your account : http://localhost:8080/activateaccount?email=" + email + "&token=" + newUser.local.activationtoken
                        }
